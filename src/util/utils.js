...
const funcs = {
    ...
    getProxyOrigin () {
        ...
        const state = process.env.PACK_ENV;
        if (state === "development") {
            return `http://${code}.merchant-d.maysatech.com`;
        } else if (state === "alpha") {
            return `http://${code}.merchant-d.maysatech.com`;
        } else if (state === "beta") {
            return `http://${code}.merchant-d.maysatech.com`;
        } else {
            return `http://${code}.merchant.maysatech.com`;
        }
    },
    // 根据状态，proxy需要跳转的新域名
    getOrigin (state) {
        ...
        if (state === "development") {
            ...
            return `http://${code}.merchant-t.maysatech.com`;
        } else if (state === "beta") {
            return `http://${code}.merchant-demo.maysatech.com`;
        } else {
            return `http://${code}.merchant.maysatech.com`;
        }
    },
